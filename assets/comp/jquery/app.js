            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.new_msg > 0) {
                        ...
                        $(".menu-count-new-msg2").html('<span class="label" style="background-color:red;color:white">' + result.new_msg + '</span>');
                        $(".menu-count-new-msg").html('<b class="label pull-right" style="background-color:red">' + result.new_msg + '</b>');
                    } else {
                        $(".menu-count-new-msg").html("");
                    }
                    ...
                    if (result.new_update > 0) {
                        ...
                        $(".menu-count-new-update").html('<b class="label pull-right" style="background-color:orange">' + result.new_update + '</b>');
                    } else {
                        $(".menu-count-new-update").html("");
                    }
                    ...
                    if (result.pending_siswa > 0) {
                        ...
                        $(".menu-count-pending-siswa2").html('<span class="label" style="background-color:red;color:white">' + result.pending_siswa + '</span>');
                        $(".menu-count-pending-siswa").html('<b class="label pull-right" style="background-color:red">' + result.pending_siswa + '</b>');
                    } else {
                        $(".menu-count-pending-siswa").html("");
                    }
                    ...
                    if (result.pending_pengajar > 0) {
                        ...
                        $(".menu-count-pending-pengajar2").html('<b class="label" style="background-color:red;color:white">' + result.pending_pengajar + '</b>');
                        $(".menu-count-pending-pengajar").html('<b class="label blue pull-right">' + result.pending_pengajar + '</b>');
                    } else {
                        $(".menu-count-pending-pengajar").html("");
                    }
