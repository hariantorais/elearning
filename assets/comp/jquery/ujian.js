...
function hide_countdown() {
    $(".countdown").hide();
    $(".box-show-hide-countdown").html('<a href="javascript:void(0)" onclick="show_countdown()"><i class="icon icon-eye-open"></i> Tampilkan Waktu</a>');
    $.ajax({
        method: "POST",
...
function show_countdown() {
    $(".countdown").show();
    $(".box-show-hide-countdown").html('<a href="javascript:void(0)" onclick="hide_countdown()"><i class="icon icon-eye-close"></i> Sembunyikan Waktu</a>');
    $.ajax({
        method: "POST",
        url: site_url + '/ajax/post_data/hide_show_countdown',
