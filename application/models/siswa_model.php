...
class Siswa_model extends CI_Model
{
    ...
    public function create(
        ...
        public function retrieve_user($siswa_id){
        
         $this->db->select('login.*,kelas.nama as nama_kelas, siswa.nama as nama_siswa');
         $this->db->from('login');
         $this->db->join('siswa','siswa.id=login.siswa_id');
         $this->db->join('kelas_siswa','kelas_siswa.siswa_id=login.siswa_id');
         $this->db->join('kelas','kelas.id=kelas_siswa.kelas_id');
         $this->db->where('login.siswa_id', $siswa_id);
         $query = $this->db->get();
