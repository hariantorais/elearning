...
class Materi_model extends CI_Model
{
    ...
    public function retrieve_allbysis(
        ...
        $siswa_iduser = get_sess_data('user', 'id');

        $where['absen_siswa'] = array('materi.id = absen_siswa.materi_id', 'join', 'inner');
        $where['siswa'] = array('absen_siswa.siswa_id = siswa.id', 'join', 'inner');
        $where['absen_siswa.absen'] = array(1, 'where');
        $where['absen_siswa.siswa_id'] = array($siswa_iduser, 'where');
