...
class MY_Controller extends CI_Controller
{
    ...
    public $default_timezone = "Asia/Ujung_Pandang";
    ...
    function __construct()
    {
        ...
        $error_install = "Database belum tersedia, silahkan import database mbo.sql terlebih dahulu.";
        try {
            check_db_connection();
        } catch (Exception $e) {
        ...
        $this->load->model(array('config_model', 'kelas_model', 'login_model', 'mapel_model', 'materi_model', 'pengajar_model', 'siswa_model', 'tugas_model', 'msg_model', 'pengumuman_model', 'komentar_model','absen_model'));
