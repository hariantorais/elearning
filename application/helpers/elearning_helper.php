...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        ...
        'copyright_setup'   => 'smp.sch.id'.'&copy; 2020',
        ...
        'site_name_default' => 'Media Belajar Online',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = get_pengaturan('nama-sekolah', 'value').' &copy; 2020 ' ;
        $return['site_name'] = get_pengaturan('nama-sekolah', 'value');
